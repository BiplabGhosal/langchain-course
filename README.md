...
- **LLM Support** - OpenAI, Azure OpenAI, Anthropic, Ollama, and other providers
...
- Access to an LLM (can be open source via Ollama, or cloud providers like Azure OpenAI, OpenAI, Anthropic, Gemini)
